...
public class FlowExecutor {
    ...
    public void executeFlow(FlowExecution flowExecution) {
        ...
        StepExecutionContext context = new StepExecutionContextImpl
                (flowExecution.getFlowDefinition().getName2DDMap(),flowExecution.getFlowDefinition().getIOName2aliasMap(), flowExecution.getFlowDefinition().getStepName2aliasMap()); // actual object goes here...
